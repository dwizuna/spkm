	...
	<div class="container">
      ...
      <nav class="navbar navbar-default">
		...
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li><a href="subkriteria.php">Data Sub Kriteria</a></li>
		  <li class="active">Tambah Data Sub Kriteria</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Tambah Data Sub Kriteria</div>
		  <div class="panel-body">
							<form role="form" method="post" action="add-sk.php">
                                    <div class="box-body">
										<?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="subkriteria" id="subkriteria" placeholder="Nama Sub Kriteria" required >
                                        </div>
										<div class="form-group">
                                            <label for="skor">Skor</label>
                                            <input type="text" class="form-control" name="skor" id="skor" placeholder="Skor Sub Kriteria" required >
                                        </div>
                                    </div><!-- /.box-body -->
